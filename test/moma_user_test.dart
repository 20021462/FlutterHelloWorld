...
void main(){
  ...
  user.addTransaction(Transaction(20000, DateTime(2022,10,23), GASOLINE_EXPENSES , ""));
  user.addTransaction(Transaction(20000, DateTime(2022,10,20), FOOD , ""));
  user.addTransaction(Transaction(20000, DateTime(2022,10,22), FOOD , ""));

  test('get email test', () => {
    expect(user.gmail,"test@gmail.com")
  });

  test('get curent money test', () => {
    expect(user.getCurrentMoney(),20000)
  });
  ...
  test('find transaction test', () => {
    expect(user.findID(1),Transaction(20000, DateTime(2022,10,22), FOOD , ""))
  });

  test('remove transaction test', () => {
    expect(user.removeID(2),Transaction(20000, DateTime(2022,10,21), GASOLINE_EXPENSES , ""))
  });

  user.showTransactions();

  test('getID transaction test', () => {
    expect(user.findID(0).getID(),0)
  });
